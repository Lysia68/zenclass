...
function AlbertChat({ isMobile, studioName, onNeedsHuman }) {
  ...
  const FAQ = [
    ...
    { k: ["pack","abonnement","formule","crédit"], a: "Gérez vos abonnements dans la section Abonnements. Créez des abonnements mensuels (illimités) ou à la séance (crédits). Assignez un abonnement à un membre depuis sa fiche → bouton Abonnement." },
